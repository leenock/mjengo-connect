...
export default function AdminManageFundis() {
  ...
  const loadFundis = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(
        `/api/fundi/getAllFundis?${params.toString()}`,
        {
  ...
  const deleteFundi = async (id: string) => {
    ...
    try {
      const res = await fetch(
        `/api/fundi/admin/deleteFundi/${id}`,
        {
          method: "DELETE",
          headers: { ...AdminAuthService.getAuthHeaders() },
        }
  ...
  const saveFundi = async () => {
    ...
    try {
      const res = await fetch(
        `/api/fundi/admin/updateFundiAdmin/${editFundi.id}`,
        {
          method: "PUT",
          headers: {
  ...
  useEffect(() => {
    const fetchCurrentUser = async () => {
      try {
        ...
        const res = await fetch(`/api/admin/getAdmin/${userData.id}`, {
          headers: { ...AdminAuthService.getAuthHeaders() },
        });
        if (res.ok) {
