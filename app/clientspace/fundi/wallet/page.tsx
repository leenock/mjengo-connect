...
import FundiAuthService, {
  type FundiUserData,
} from "@/app/services/fundi_user";
...
export default function AddFundsPage() {
  ...
  const [isStkPushProcessing, setIsStkPushProcessing] = useState(false);
  ...
  const handleMpesaStkPush = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const stkPushPayload = {
        ...
        email: kopokopoData.email?.trim() || undefined,
        metadata: {
          fundiId: currentUser?.id || "",
          reference: `FUNDI_WALLET_TOPUP_${Date.now()}`,
          notes: `Fundi wallet top-up of KES ${parsedAmount}`,
        },
      };
          ...
          <div className="w-full max-w-lg rounded-2xl border border-white/30 bg-white/90 p-6 shadow-2xl backdrop-blur-xl max-h-[90vh] overflow-y-auto">
            <div className="mb-4">
              ...
              <p className="mt-2 text-sm text-slate-600">
                ...
                to your wallet. Please fill in your details to initiate the STK Push.
              </p>
            </div>
