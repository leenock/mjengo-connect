...
router.post("/jobs/expire-paid", cronOrAdminAuth, expirePaidJobsController) // Cron secret or admin
router.post("/jobs/expire-unpaid-active", cronOrAdminAuth, expireUnpaidActiveJobsController) // Cron secret or admin
